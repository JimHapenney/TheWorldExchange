...
function loadOrderbook() {
  ...
  new Promise(function(resolve, reject) {
    ...
    if(showOrderbook && orderbook!=null) {
      ...
      bidasktable+="<tr><td colspan='"+(cols)+"' style='text-align:left; width:40%; border-width:0px;'>"+(mktcap1>0? "Total "+symbol1+" Issued: "+nFormatter(mktcap1, 2):"")+"</td><td style='border-width:0; width:20%;'>"+new Date(Date.now()).toLocaleString()+"</td><td colspan='"+(cols)+"' style='text-align:right; width:40%; border-width:0px;'>"+(mktcap2>0? "Total "+symbol2+" Issued: "+nFormatter(mktcap2, 2):"")+"</td></tr>";
