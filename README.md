...
- Fully client-side implementation for all the benefits of a "cold wallet" (no storing or passing of information on remote servers), including the ability to generate and validate wallets/addresses completely offline by saving the webpage to your desktop.
