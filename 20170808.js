    ...
    try {
      ...
      // Least important stuff go last
          ...
          $.get( dataAPI+"/v2/gateways/", function( data ) {
            ...
            $("#chatHistoryContents").append(" Each message costs a fraction of "+baseCurrency+" ("+nFormatter(fee+0.000001, accuracy)+") due to minimum transaction cost + size but nothing more. Display names will be added in next update.<br /><hr />");
            runChat();
