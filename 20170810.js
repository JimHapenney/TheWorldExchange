...
function loadAccount(loadOrderbookNext=false) {
  ...
  new Promise(function(resolve, reject) { 
    ...
    var commonMenu = "<div id='chatHide' "+(showChat? "":"style='display:none;'")+"><a href='#' onclick='hideChatbox(); "+(isMobile()? "hideMiscMenu();":"")+"'>Hide Chat</a></div><div id='chatShow' "+(!showChat? "":"style='display:none;'")+"><a  href='#' onclick='showChatbox(); "+(isMobile()? "hideMiscMenu();":"")+"'>Show Chat</a></div>";
