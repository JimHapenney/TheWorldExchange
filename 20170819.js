...
function selectServer(selectedServer=null) {
...
// Close/open chat box
function showChatbox(updateMenu = true) {
  showChat = true;
...
function hideChatbox(updateMenu = true) {
  showChat = false; 
...
function rescaleWindow(resizeChat=true) {
...
function showLogin(resetFields=true) {
