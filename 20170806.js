...
function loadAccount(loadOrderbookNext=false) {
  ...
  new Promise(function(resolve, reject) { 
    ...
    var commonMenu = "<div id='chatHide' "+(showChat? "":"style='display:none;'")+"><a href='#' onclick='closeChat();'>Hide Chat</a></div><div id='chatShow' "+(!showChat? "":"style='display:none;'")+"><a  href='#' onclick='openChat();'>Show Chat</a></div>";
...
function refreshLayout() {
  if($("#controlMiscMenu").css("display")=="none" || ($("#showMiscMenu").css("display")=="none" && $("#hideMiscMenu").css("display")=="none"))
